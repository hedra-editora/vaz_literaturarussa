...
\section{\uppercase{N}omadismo \protect\scalebox{0.8}{X} \uppercase{S}edentarismo, a visão global e\ldots{} a democracia}
...
\chapter*{Aurora Bernardini entrevista Joseph Frank:\\
sobre Dostoiévski\footnote{Publicado em \emph{Folha de S. Paulo}, em 13/01/2008. A entrevista foi traduzida do inglês por Luiz Roberto Gonçalves.}}
...
1968. A escritora e tradutora Elsa Triolet (Ella Kagan, 1896--1970) era a irmã mais nova de Lili Brik (1891--1978), o grande amor da vida de Maiakóvski. (\scalebox{0.8}{N}. da \scalebox{0.8}{E}.)} um volume de sua prosa, com introdução de F. Stepun, editado em Nova York,\footnote{\scalebox{0.8}{TSVETAEVA}, Marina.
...
ensaio de Toltsói, de 1859, sobre os contos de suas \emph{Cartilhas} (\scalebox{0.8}{TOLSTÓI}, 2005), recontados pelos escolares de Iásnaia Poliana; o de Gógol, \emph{Algumas palavras sobre Púchkin}, de 1835; e o de Dobroliúbov,
...
singularização, a ``Da evolução literária''\footnote{\scalebox{0.8}{TYNIÁNOV}, Iúri. Da evolução literária.
 In: \scalebox{0.8}{TOLEDO}, 1976.} de Tyniánov, etc., etc. As
