...
de Aleksandr Púchkin (1799--1837) a Mikhail Lêrmontov (1814--1841),
...
russo, tão presente nas descrições do Oriente de Púchkin e de Lêrmontov,
...
para Karakózov\footnote{Dmítri Karakózov (1840-1866) cometeu atentado
  ...
  Iliá Riépin, que retratou o condenado. (N. da E.)} disparar seu tiro
solitário contra Alexandre II. O fato é que, se Dostoiévski realmente,
...
medo''.\footnote{LO GATTO, Ettore. \emph{Dostoievskij nella Coscienza
...
delas, Nikolai, chega a confessar o crime. O fato de o delegado de
...
também doente, a qual sempre o visitara na prisão, ritualisticamente o
...
o Mal (...) O Mal é dialético: a autodestruição do Mal já é o início da
...
Diabo em colóquio com Ivan em \emph{Os Irmãos Karamázov} (...) Mas, se a
...
ainda mais originária e profunda: a experiência da Liberdade... Que a
...
Evangelho, com a qual a liberdade do Cristo liberta os homens.\footnote{PAREYSON,
...
palavra, o professor Ével Gasparini, da Universidade de Pádua...
...
eslavos.'' (\emph{Apud} PAREYSON, 1972, p. 23) Para chegar a este ponto
...
russa, ligados ao \emph{raskol},\footnote{\emph{Raskol} (``cisma'',
  ...
  Raskólnikov. (N. da. E.)} como, por exemplo, o caso de um certo
...
na terra, que Dostoiévski não define, é cristão?''\footnote{PASCAL,
...
\begin{quote}
{[}...{]} com seu caráter ambíguo implicam, comportam, carregam, um
...
símbolo que representam, o caráter simbólico que representam. (PAREYSON,
1972, p. 23)
\end{quote}
...
\begin{quote}
Os escritores realistas do século XIX sempre deram aos seus leitores a
...
as provas para as respostas possíveis.\footnote{STEINER, George.
...
permitir um horror comoesse!...

-- Mas permite com outras.

-- Não, não! Deus a protegerá, Deus!... -- repetiu ela fora de si.

-- É, mas pode ser que Deus absolutamente não exista -- respondeu
Raskólnikov até com certa maldade, desatou a rir e olhou para
ela.\footnote{DOSTOIÉVSKI, Fiódor. \emph{Crime e Castigo}. Tradução
...
chegara esse momento... Eles quiseram falar mas não conseguiram. As
...
\textbf{De Mikhail Bakhtin a Milan Kundera, os intérpretes de
...
sentimental. (...) Esses sentimentos (uma hierarquia deles) são reações
...
Kundera -- não importa o quão moderno, não importa o quão comum. (...)
Privado da graça \textbf{{[}}embora talvez fosse melhor dizer
...
\emph{ideia-sentimento}, sua ideia-\emph{força}.
...
Grossman encontra três camadas constitutivas: l) o \emph{fundo
...
chamar-se \emph{Os irmãos Karamázov}\textbf{)}, o episódio do Grande
...
(\emph{Dom Carlos}\textbf{)}, pelo empolgamento moral; de Balzac, pela
...
--, não há unicidade de estilo em Dostoiévski: à polifonia das vozes só
...
Este breve romance, \emph{Khadji}-\emph{Murát}, na tradução de Boris
Schnaiderman revista para esta edição da Cosac Naify\footnote{TOLSTÓI,
...
de vista estilístico, \emph{Khadji}-\emph{Murát} insere-se entre as
...
Tchetchênia, graças aos serviços que prestaria ao czar Nikolai I.
...
que é a qrte?})\footnote{TOLSTÓI, Lev. \emph{O que é a arte?} Lisboa:
...
estada na Academia. Dois anos depois, acabou sendo expulso por haver
...
Níjni-Nóvgorod (1885). Apesar de, em 1879, ter tido uma sua primeira
...
companhia}\footnote{KOROLENKO, Vladímir. \emph{Em má companhia. O músico
...
meu pai, e muito mais naquele tempo (...) Eu tremia só de pensar que um
...
tratou da surdez em \emph{História de uma criança surda}).\footnote{FERRARI,
...
\textbf{1. Prolegômenos}

Entre l875 e l922 -- diz \emph{Presença da Literatura Brasileira: do
romantismo ao simbolismo} de Antonio Candido e J. Aderaldo
Castello,\footnote{CANDIDO, Antonio; CASTELLO, J. Aderaldo.
...
os estudos publicísticos, a gramática, os estudos e a crítica
literários. A galeria de ilustres é longa, a começar por Rui Barbosa
(1849-1923) e por Euclides da Cunha (1866-1909).

O panorama cultural desse período sofreu, como não podia deixar de ser,
a influência do naturalismo\emph{,} enquanto busca de uma explicação
...
demasiado idealizada da realidade. \emph{Race, Temps et Milieu,} as
...
do parnasianismo na poesia. De fato, escritores como Stendhal\emph{,}
Balzac\emph{,} Gógol e Dickens\emph{,} embora românticos, foram
...
o naturalismo principiam oficialmente no Brasil em l880 e em 1881,
respectivamente com as \emph{Memórias Póstumas de Brás Cubas,} de
Machado de Assis, \emph{e O Mulato,} de Aluísio Azevedo.
...
enfim, a ideologia progressista (cf. Silvio Romero, desde 1868, e
Martins Júnior com \emph{A Poesia Científica e Visões de Hoje}), e,
...
e tem como iniciadores Carvalho Júnior (1855-l879) e Teófilo Dias
...
Os parnasianos reconheciam como mestres Leconte de Lisle (objetividade
...
impregnação parnasiana.'' (CANDIDO, 1974)\emph{.}

Dos dois principais poetas simbolistas brasileiros (tirante os
...
Junqueiro (cf. o sentimental e fluido \emph{Os Simples}), Eugênio de
...
Entre os simbolistas menores, notam-se: Emiliano Perneta (1866-1921),
Dario Veloso (1869-1937), Eduardo Guimaraens (1892-1928) e Pedro
Kilkerry (1885-1917).

\textbf{3. Características do simbolismo russo comparáveis às do
simbolismo brasileiro}
...
década de 90 do século XIX -- valho-me aqui da tese de doutoramento de
Krystina Pomorska, \emph{Russian Formalist Theory and its Poetic
Ambiance}\footnote{POMORSKA, Krystina. \emph{Formalismo e futurismo.}
...
sua expressão mais acabada a poesia lírica (...) Cognição através da
arte é o \emph{leitmotiv} da teoria poética simbolista, daí, como
característica decorrente, o valor atribuído à intuição.
\end{quote}

A arte como conhecimento estava ligada a seu aspecto formal. Os poetas
...
literatura russa contemporânea} (1894)\emph{,} espécie de manifesto
...
mim, quanto os encerrados em mim. (...) No som recria-se um novo mundo,
nos limites do qual eu me sinto criador da realidade; então começo a
nomear os objetos, isto é, a recriá-los novamente para mim. (PAMORSKA,
1972, p.85)
\end{quote}

Seguindo Potebniá, Biély vê a linguagem poética como a linguagem das
...
(1913)\emph{,} é ``assassinada pela razão criadora''. O poeta acaba
...
\item
  Engajamento na filosofia mística e desfazimento\emph{.}
\end{itemize}

4. Exemplos de poemas de alguns poetas considerados
...
\textbf{Hão de chorar por ela os cinamomos}
...
\chapter{Traduzir \versal{\emph{KA}}, de Velimir Khlébnikov\footnote{Texto
  publicado em KHLÉBNIKOV, Velimir. \emph{Ka.} Tradução, notas e
...
A. M. Ripelino\footnote{RIPELINO, A. M. \emph{Poesie di Chlébnikov.}
...
I. Tyniánov\footnote{TYNIÁNOV, Iúri. Introdução. In: KHLÉBNIKOV,
  Velimir. \emph{Obras reunidas (Sobránie Sotchiniénii})\emph{.}
...
da ciência e dão origem ao ``único \emph{epos} nosso do século XX''.

R. V. Dugánov comenta sua ``arte da palavra''\footnote{DUGÁNOV, R. V.
...
Baudelaire, Verlaine, Maiakóvski, os simbolistas, outros futuristas...
...
compreensíveis... e isto, de imediato, leva-nos a \emph{Ka.}
...
Profetas do Islã, o Bem e o Mal do Cristianismo, são a China antida, a
Grécia de Péricles, os Citas de Adi Saka... o Amor do Homem de todos os
tempos.

O que está em primeiro plano, no conto, são as hipóstases destas e de
outras concepções: é o mundo ``onomatomorfo'' (DUGÁNOV, 1974), onde as
...
se chocam e se decompõem, ecoam e se repelem, numa dialética continua...
...
assim como o macaco é Amenófis... tudo poder ser e não ser. Na natureza
...
edição da editora 34,\footnote{MAIAKÓVSKI, Vladímir. \emph{O percevejo.}
...
ressuscita um belo e corpulento percevejo: o \emph{Percevejus}
\emph{normalis}.
...
\emph{Percevejus} \emph{normalis} e do \emph{Philistaeus vulgaris},
...
por A. Mikháilov em \emph{Maiakóvski, o poeta da revolução}:\footnote{MIKHAILOV,
...
do autor,\footnote{MAIAKÓVSKI, Vladímir. \emph{Obras escolhidas}
  (\emph{Ízbrannye sotchiniénia}). Moscou: GIKHL, 1949.} \emph{O
...
1927-28, que se destinava ao \emph{Sovkinó}\footnote{Acrônimo de
  ...
  1924. (N. da E.)} de Leningrado. Nela, sente-se a forte influência de
...
Dobýtchin\footnote{Publicado em \versal{DOBÝTCHIN}, Leonid. \emph{Encontros com Liz e outras histórias.} Tradução Moissei
  Mountian. Prefácio Aurora Fornoni Bernardini. São Paulo: Kalinka,
  2009.}}
...
Zamiátin, Platónov e Kharms e poucos outros, o que de melhor se produziu
...
enfiada uma bacia azul com flores amarelas''. (DOBÝTCHIN, 2009, p. 39)
...
ou ``limpeza'' que aparecem aludidos no conto \textbf{``}Sávkina'', em
...
na introdução à versão americana de \emph{Encontros com Liz}\footnote{DOBYCHIN,
...
tão positivamente surpreendeu em \emph{No degrau de ouro},\footnote{TOLSTAIA,
...
(``Encontros com Liz'', DOBÝTCHIN, 2009, p. 46)
\end{quote}
...
(``O Retrato'', DOBÝTCHIN, 2009, p. 131)
\end{quote}
...
\part{contemporâneos (século \versal{XX})}
...
\textbf{Aurora Bernardini:} Liuba Kusnetsova era uma senhora que viera
...
\textbf{A.B.:} Compor versos era uma espécie de religião para Marina
...
\textbf{A.B.:} Um dos poemas que mais me impressionaram, e que talvez
...
\emph{B.R.: Apesar de uma sina tão trágica, parece difícil encontrar em
...
\emph{\textbf{B.R.:} Levando em conta o trabalho poético de Marina
...
\emph{\textbf{B.R.:} Então, o mote do conjunto da obra poética de
Tsvetáieva era...}
...
\textbf{A.B.:} Além de ser um traço da sintaxe e da gramática russas --
...
Tudo o que me leva de volta ao passado vem tendo um sabor particular
...
Em sua coletânea de ensaios sobre Dostoiévski e Bakhtin,\footnote{SCHNAIDERMAN,
