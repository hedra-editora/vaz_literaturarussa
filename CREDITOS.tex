...
mestrado, foi convidada para lecionar na \versal{USP} por Boris Schnaiderman
...
\versal{LETRA}) e de Teoria Literária e Literatura Comparada (\versal{FFLCH/USP}), tendo
...
conto de magia} (\versal{UFSC}, 2015, com S. I. Nekliúdov). Colaboradora assídua
de vários periódicos, como dos jornais \emph{Folha de S. Paulo} e
\emph{Estado de S. Paulo} e da revista \versal{CULT}. Também ministra
cursos e palestras sobre literatura e tradução, na Casa das Rosas, Casa
Guilherme de Almeida, Centro Universitário Maria Antonia (\versal{USP}), etc.
...
Editorial); em 2006, foi vencedora do prêmio \versal{APCA} pela cotradução de
...
dedicada à cultura russa. Fez pela \versal{USP} graduação em história, mestrado
...
programa de Teoria Literária e Literatura Comparada (\versal{USP}). Traduziu com
...
André, mestre em Teoria Literária e Literatura Comparada (\versal{USP}) e doutor
em Literatura e Cultura Russa (\versal{USP}). É professor na área de Língua
Portuguesa, Literatura, Redação e Metodologia Científica no Centro
Estadual de Educação Tecnológica Paula Souza (\versal{ETEC} e \versal{FATEC}). É professor
