...
poema\ldots{} (Troyat, \emph{Pouchkine: biographie}, pp. 371--373).\footnote{No original: ``\emph{Sais-tu quelles sont mes
  ...
  merveille ces contes! Chacun d'entre eux est un poème\ldots{}}''}
\end{quote}
...
Jornal da Sibéria (\emph{Idem, ibidem}).\footnote{No original: ``\emph{Des vers, des vers,
  ...
  français, absolument! Si possible envie moi le dernier Genlis, \emph{Childe Harold}, Lamartine\ldots{} les œuvres dramatiques de Schiller, \emph{Don Juan}\ldots{} et Le Courier de Siberie''.}}
\end{quote}
