...
\chapter{A LONGA PROVAÇÃO DE DOSTOIÉVSKI: RECORDAÇÕES DA CASA DOS MORTOS
...
A força da novela (onde o se enredo identifica- com o assunto, sem
...
\chapter{TOLSTOISMO E HINDUISMO\textsuperscript{(1)}}
...
\chapter{TCHEKHOV, O INTERPRETE DO GRANDE TÉDIO RUSSO}\footnote{O Estado
...
\chapter{ASPECTOS DA NATUREZA EM VELÍMIR KHLÉBNIKOV E EM MANOEL DE
BARROS}
...
\chapter{FRIEDRICH GORENSTEIN: \emph{SALMO}- UM ROMANCE-MEDITAÇÃO SOBRE
...
\chapter{REVERBERAÇÕES DO FORMALISMO RUSSO NA CRÍTICA LITERÁRIA
