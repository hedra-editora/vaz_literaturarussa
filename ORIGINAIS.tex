...
Numa admirável introdução a \emph{The Oxford Book of Russian Verses}, \footnote{\versal{BARING}, Maurice. \emph{The Oxford Book of Russian Verses.} Oxford: Claredon Press, 1958.}
...
só começaria a ser demolida no século \versal{XVIII}, já no reinado de
Pedro, o Grande.
...
sequer um aceno sobre aquilo que me surpreendia em toda parte\ldots{}\footnote{\versal{TURGUÊNIEV}, Ivan. A propósito de \emph{Pais e filhos}(de 1868--1869). In: \emph{Memórias de vida e de literatura. Obras reunidas}. Vol.\versal{X}. Moscou: Ed. Estatal de Literatura,1962.} 
\end{quote}
...
e depois?\footnote{\versal{TURGUÊNIEV}, Ivan. \emph{Pais e filhos}. Tradução Ivan Emilianovitch. São Paulo: Ed. Livraria Martins, 1941.} 
\end{quote}
...
versão de Irineu Franco Perpetuo\footnote{\versal{TURGUÊNIEV}, Ivan. \emph{Memórias de uma caçador}. Tradução e posfácio Irineu Franco Perpetuo. São Paulo: Editora 34, 2013.}, entra no rol das grandes
...
Sem dúvida, as \emph{Memórias} de Turguêniev contribuíram para a abolição da servidão da gleba na Rússia (1861), já no reinado do czar seguinte, Alexandre \versal{II}, quando o livro foi republicado (1859), ganhando a versão final (com mais três episódios) em 1874.
...
Hoje, suas melhores obras são tidas como clássicos da literatura universal e críticos e escritores apreciam sobremaneira seu estilo original. Como Isaiah Berlin, que declara: ``Turguêniev é o melhor estilista russo depois de Púchkin''; Harold Bloom, que o considera um dos escritores que mais influenciaram a literatura anglo"-saxã; ou Alice Munro, que o torna um interlocutor de um dos contos de \emph{Ódio, amizade, namoro, amor, casamento}\footnote{\versal{MUNRO}, Alice. \emph{Ódio, amizade, namoro, amor, casamento}. São Paulo: Globo Editora, 2004.}.
...
Um desses desvios seria a Revolução de 1917, na visão que certos membros da \emph{intelligentsia} têm do evento. O próprio Nikolai Trubetskói, partidário da visão eurásica e não europeizada da Rússia, acreditando que ``a Rússia de Ivan \versal{IV} é a Horda russificada e \emph{bizantinizada}'', concluía que o novo regime bolchevista levava adiante a europeização da Rússia, dando as costas à natureza eurasiana do país. ``Não é de admirar, portanto'', diz ele, ``que seus melhores adeptos sejam, assim como sob Pedro \versal{I}, os indivíduos originários dos países bálticos e que tantos visitantes ocidentais voltem da Rússia
...
Para concluir, nada melhor que um trecho de uma conversação apontada por Nivat e retirada de \emph{Vida e destino} (1960), a obra"-prima de Vassíli Grossman, romance considerado por muitos o \emph{Guerra e paz} do século \versal{XX}:
...
1880,\footnote{\versal{DOSTOIÉVSKI}, Fiódor. Discurso sobre Púchkin. \emph{Diário de um escritor. Obras completas, tomo 26.}.Leningrado: Nauka, 1984} por ocasião da inauguração do monumento a Aleksandr Púchkin
...
Por outro lado, outro crítico"-biógrafo, Leonid Grossman,\footnote{\versal{GROSSMAN}, Leonid. \emph{Dostoiévski artista}. Rio de Janeiro: Civilização brasileira, 1967.} perlustra a biblioteca de Dostoiévski, o que nos permite ver semelhanças e diferenças entre as leituras dos escritores (não esqueçamos que, quando Púchkin morreu, Dostoiévski tinha 16 anos e que lhe sobreviveu 44 anos).
...
Vólguin,\footnote{\versal{VÓLGUIN}, Ígor. \emph{O
...
(tanto a de Alexandre \versal{I} como a de Nicolau \versal{I}),
Dostoiévski, cabe mencionar, mantinha amizade estreita justamente com Pobedonóstsev, a expressão máxima da censura na época de Alexandre \versal{III}.
...
Nicolau \versal{I}, ali infiltrados --- e a leitura da
...
prosa poesia},\footnote{\versal{SCHNAIDERMAN}, Boris.
...
acabará bem'' --- ele escreve ao irmão. (\versal{DOSTOIÉVSKI},
...
entrada um balde, o odor era insuportável. (\versal{DOSTOIÉVSKI}, 2006)
\end{quote}
...
levantado em \emph{Estação Carandiru}\footnote{\versal{VARELA,}Drauzio.
...
\emph{De Senectute},\footnote{\versal{BOBBIO}, Norberto.
...
de 1940.\footnote{\versal{TROYAT}, Henri. \emph{Dostoievsky}.
...
\emph{Problemas da poética de Dostoiévski}\footnote{\versal{BAKHTIN}, Mikhail.
...
do séc.\versal{III} a.C., foi um dos componentes usados por
Mikhail Bakhtin, nesse estudo, para definir a linha carnavalesca
do romance europeu, cujas origens estariam no gênero sério-cômico. Dostoiévski, segundo Bakhtin, levou adiante a linha carnavalesca, inserindo nela o dialogismo e criando seu tipo polifônico, na direção contrária do romance tradicional monológico, no qual todos os elementos da composção servem para sublinhar um ponto de vista. (\versal{N}. da \versal{E}.)} ---, situa entre perguntas e respostas"-perguntas:
...
os literatos russos do século \versal{XIX}. (N. da E.)} e
...
para a José Olympio,\footnote{\versal{DOSTOIEVSKI}, Fiódor.
...
et punir chez Dostoïevski}.\footnote{\versal{NIVAT}, Georges.
\emph{Juger et punir chez Dostoïevski}. In: \versal{CAVALIERE},
...
Luzes}.\footnote{\versal{TODOROV}, Tzvetan. \emph{O espírito
...
\chapter{A consciência em Dostoiévski (\emph{Crime e castigo})\footnote{Texto (parte) retirado de: \versal{BERNARDINI}, Fornoni Aurora. ``Dostoiévski: criação, poesia e crítica''. In: \versal{CAVALIERE}, Arlete \emph{et al}. (orgs.). \emph{Caderno de Literatura e Cultura Russa}. Cotia: Ateliê Editorial, 2008, pp. 301-323.}}

Não é sem motivo que \emph{Dostoiévski --- os anos de provação (1850--1859)}\footnote{\versal{FRANK}, Joseph. \emph{Dostoiévski --- os anos de   provação (1850--1859)}. Tradução Vera Pereira. São Paulo: Edusp, 1999.}, o segundo volume da série que Joseph Frank dedicou ao escritor, tenha recebido o \emph{National Books Critics Award}, para biografia, de 1984. O livro lê"-se com extremo interesse do começo ao fim, e com a mesma impaciência fica"-se torcendo para saber como irão se desenrolar os fatos
...
continha fontes infinitas de vida para o coração do outro. (\versal{DOSTOIÉVSKI}, 2010, p. 558)
\end{quote}
...
milagrosos (1865--1871)} (2003); \emph{Pelo prisma russo -- ensaios sobre literatura e cultura};\footnote{\versal{FRANK}, Joseph. \emph{Pelo prisma russo: ensaios sobre literatura e cultura}. Tradução Paula Rolim e Francisco Achcar. São Paulo: Edusp, 1992.} \emph{Dostoiévski -- o manto do
...
russos sofriam perdas terríveis durante a Guerra Russo"-Turca.\footnote{Guerra russo-turca (1877--1878), conflito ocorrido nos Bálcãs e no Cáucaso entre o Império Otomano e a Rússia, coligada à Bulgária, Romênia e Sérvia, que, como resultado, conseguiram sua independência dos otomanos. (\versal{N}. da \versal{E}.)}
...
Encontros Internacionais do \versal{CCBB} (respectivamente sobre
...
do século \versal{XIX}'', mas também por seus contos breves,
...
com Maksim Górki\footnote{\versal{GÓRKI}, Maksim. \emph{Leão
...
1902)\footnote{\versal{TOLSTÓI}, Lev. \emph{O que é religião е
...
Sintetizando"-se agora o conceito de consciência em Tolstói, lembramos que em suas obras e, particularmente, em seus \emph{Diários} de 1900--1904, depreende"-se que ela é formulada em três gradações: \versal{I} --- procura do bem somente para si, para o ser material imaginário (atos exteriores de adoração); \versal{II} --- procura do bem somente para si, para o ser espiritual imaginário (atos íntimos de servidão a Deus); \versal{III} --- procura do bem para todo o resto com que tem contato (contemplação interna e união com Deus).
...
Tolstói, está associada a um estranhamento do mundo, a uma contestação das convenções, a um combate à coisificação das relações humanas. Chklóvski submeteu o conceito de estranhamento a diversas reformulações durante sua trajetória intelectual. (\versal{N}.da \versal{E}.)}
...
peu}, donc lá ou commence l'art}''\footnote{\versal{TOLSTOÏ}, Léon. \emph{Écrits sur l´art}. Paris: Gallimard, 1971, pp.
200--201.}.
...
hostilidade e uma hostilidade fria, como em \emph{Anna Kariénina} (\versal{GÓRKI}, 2006, pp. 16--17.).
\end{quote}
...
Lévin, irritado com a objeção. \footnote{\versal{TOLSTÓI}, L. \emph{Anna Kariênina}. Tradução Rubens Figueiredo. São Paulo: CosacNaify, 2005, p. 98.}.
\end{quote}
...
escolha dos métodos agrícolas\ldots{} (\versal{TOLSTÓI}, 2005, p. 168.)
\end{quote}
...
do povo. (\versal{TOLSTÓI}, 2005, p. 340.)
\end{quote}
...
escritor''.(\versal{GÓRKI}, 2006, p. 51.)
...
orgulhoso. \footnote{\versal{TOLSTOJ}, Lev. \emph{Diario intimo (1900--1904.} Tradução Erme Cadei. Milão: Mondadori, 1929. (Tradução nossa.)}
\end{quote}
...
durante os períodos precedentes. (\versal{TOLSTOJ}, 1929) 
\end{quote}
...
sua tradução,\footnote{\versal{TOLSTÓI}, Lev. \emph{Felicidade
...
amor a Deus, mas falou desse tema friamente e cansado.'' (\versal{GÓRKI}, 1983)
...
Kariênina}, \versal{IV} parte, cap. \versal{X}.). Mais curioso
...
de A. P. Tchékhov,\footnote{\versal{TCHÉKHOV}, Anton. \emph{A dama
...
defeitos {[}e qualidades{]} da nação''(\versal{GÓRKI}, 2006, p. 33.),
...
\chapter{As cartilhas do Conde Lev Nikoláievich Tolstói}\footnote{Publicado como prefácio de \versal{TOLSTÓI}, Lev. {Contos da nova cartilha: primeiro livro de leitura}. Tradução M. Aparecida B. P. Soares. Cotia: Ateliê Editorial, 2005, pp. 11--20.}
...
em companhia de Tolstói. (\versal{N.} da {E.})} à Iásnaia Poliana,
para onde este remeteu, a pedido do escritor, métodos e livros
utilizados nos \versal{EUA}, em particular, uma espécie de
crestomatia progressiva: \emph{The first, The second} e \emph{The third
reader}\footnote{\versal{TOLSTOÏ}, Léon. \emph{Les quatre livres de
...
Há certo número de escritos (contos, fábulas, contos maravilhosos, histórias verdadeiras, variantes de textos, fragmentos, descrições, etc.) que não foram incluídos pelo autor na redação final, mas aos quais temos acesso pela publicação da Editora Instrução.\footnote{\versal{TOLSTÓI}, Lev. \emph{Cartilha; Nova Cartilha}. Moscou: Editora Instrução (\emph{Prosveschiénie}, 1978.)}
...
carta de 12 de novembro de 1872. (\versal{TOLSTOÏ}, 1928,
...
Nos outros livros, informa Charles Salomon (\versal{TOLSTOÏ},
...
de outubro de 1881.(\versal{TOLSTOÏ}, 1928)}
...
nova cartilha \versal{I} e \versal{II}} (vol. 1) editados pela
Ateliê, respectivamente, em 2005 e em 2013.



\chapter{\emph{A morte de Ivan Ilitch} -- Lev Tolstói em quadrinhos}\footnote{Publicado no suplemento Cultura do jornal \emph{O Estado de S. Paulo}, em 19/9/2014, com o título ``\versal{HQ} revela a atualidade de novela escrita por Lev Tolstói''.}
...
vida do autor.\footnote{\versal{TOLSTÓI}, Lev. \emph{A morte de
...
(\versal{TOLSTÓI}, 2006, p.17--18) E por ali vai: os colegas
...
procuram\footnote{\versal{VÁSSINA}, Elena (org.). \emph{Liev
...
Tchetchênia, graças aos serviços que prestaria ao czar Nicolau \versal{I}.
...
mas o de um verdadeiro homem \ldots{}\footnote{\versal{TCHÉKHOV},
...
Provavelmente porque só no século \versal{XI} foi possível encarar
...
Quando Tchékhov nasceu, em 1860, o czar Alexandre \versal{II}
...
implacavelmente, lançaram mão do terrorismo. Alexandre \versal{II}
foi assassinado. Alexandre \versal{III} subiu ao trono e com ele
...
A ascensão ao trono de Nicolau \versal{II}, em 1894, não modificaria
...
dono\ldots{}\footnote{\versal{TCHÉKHOV}, Anton. \emph{O homem no
...
de Tyniánov (\emph{O problema da linguagem poética \versal{I} e \versal{II}})
...
surda}).\footnote{\versal{FERRARI}, Alícia. \emph{História de uma
...
humanidade\ldots{}''. (\versal{GÓRKI}, 1983)
...
todo o mundo'' --- escreve Boris Schnaiderman\footnote{\versal{SCHNAIDERMAN},
...
literatura surgida em fins do séc. \versal{XIX} e começo do séc.
\versal{XX}. A sua influência exerceu"-se também no sentido de
...
nesta obra justamente aquilo que se tem exaltado na \versal{URSS}
...
descrição da realidade a uma compreensão do materialismo histórico etc. (\versal{SCHNAIDERMAN}, 1983)
\end{quote}
...
surpreendente´’'.\footnote{\versal{LÊNIN}, Vladímir. \emph{Obras
...
(\versal{N}. da {E}.)} que ele passou a dirigir de volta à
...
como \emph{Ganhando meu pão}\footnote{\versal{GÓRKI}, Máximo.
...
profundamente''.(\versal{GÓRKI}, 1986, p. 161.) Após ter
...
amarra este calçado\ldots{}''. (\versal{GÓRKI}, 1986, p. 329.).
...
em \emph{Contos escolhidos},\footnote{\versal{BÚNIN}, Ivan.
...
\chapter{Traduzir \versal{\emph{\versal{KA}}}, de Velimir
Khlébnikov\footnote{Texto publicado em \versal{KHLÉBNIKOV},
...
diferente do nome usual Velímir. (\versal{N.} da \versal{E.})} é
...
poética nova e universal. (\versal{N}. da {E}.)}. pode-se falar
...
A. M. Ripelino\footnote{\versal{RIPELINO}, A. M. \emph{Poesie
...
I. Tyniánov\footnote{\versal{TYNIÁNOV}, Iúri. Introdução. In:
\versal{KHLÉBNIKOV}, Velimir. \emph{Obras reunidas}
...
R. V. Dugánov comenta sua ``arte da palavra''\footnote{\versal{DUGÁNOV},
...
\chapter{Encontro de andarilhosfootnote{Publicado na revista
  \emph{Qorpus} (\versal{UFSC}) em 14/11/2018.}}
...
revista \emph{Bri"-a"-Brac}.\footnote{\versal{BARROS}, Manoel de. \emph{Revista de
...
e escrever a história de sua criação poética.\footnote{Dugánov (com
  ...
  (Moscou, \versal{IMLI RAN}), depois da morte do crítico (\versal{N}. da \versal{E}.).}
...
de literatura russa da \versal{USP}, arrancou exclamações de maravilha.
...
Dugánov!\footnote{\versal{DUGÁNOV}, Rúdolf. \emph{Velímir Khlébnikov -- A
...
descendentes dos pássaros de Setch'' (\versal{DUGÁNOV}, 1990).

A origem bandida e cossaca, entre o Oriente e o Ocidente,
era referência importante para o espírito rebelde, unificador e
sintético de sua obra, para seu ``destino de poeta'' (\versal{DUGÁNOV}, 1990, p. 12). Seu pai, de uma
...
(\ldots{})\footnote{Меня окружали степь, цветы, ревучие верблюды, /
  ...
  текли, за ними годы. (\ldots{}). (\versal{DUGÁNOV}, 1990, p. 12)}
\end{verse}
...
caixa de cal do crânio'' (\versal{DUGÁNOV}, 1990, p. 14).
...
professor'' (\versal{DUGÁNOV}, 1990, p. 14). Provavelmente pressentiam a desmedida abnegação do futuro
poeta.
...
destino histórico da Rússia'' (\versal{DUGÁNOV}, 1990, p. 15). Da mesma forma que ele não se limitou, em
...
sensação bruxuleante de uma terceira'' (\versal{DUGÁNOV}, 1990, p. 95). Assim temos:
...
Α arcada celeste, ardente de glória estelar, \\
...
(\ldots{})\footnote{(\ldots{}) И в небесах зажглись, как очи, / Большие серые
  ...
  напишет над утесом/ Большие медленные брови. (\ldots{}) (\versal{DUGÁNOV}, 1990, p.
  98)}
\end{verse}
...
visível, conforme a posição da terra em relação ao sol'' (\versal{DUGÁNOV}, 1990, p.98). Na primeira, a
...
solar, o lunar e o estelar''.\footnote{\versal{SOLOVIÓV}, Vladímir. A beleza e a
...
Nessa quadra, ligada pela rima \versal{ABAB}, todos os versos levam acento na 6ª
...
\emph{especularidade} de \versal{I} e \versal{III} e para o paralelismo de \versal{III} e \versal{IV}):
...
\begin{verse}
\versal{I}: \emph{Zamiérnoie bezmiérnym pólnia} \\
(Enchendo o comensurável com o \\
incomensurável) \\[8pt]

\versal{II}: \emph{Zam\textbf{í}rnoie bezmiérnym pólnia} \\
...
tempo, ``mundo'' e ``paz''.\footnote{Com a reforma ortográfica de 1917--1918, o antigo ``i''
  ...
  ``paz''. Agora мир significa tanto um como outro (\versal{N}. da \versal{E}.)}
...
edição da editora 34,\footnote{\versal{MAIAKÓVSKI}, Vladímir.
...
no qual Hegel\footnote{\versal{HEGEl}, Georg Wilhelm Friedrich.
...
Pavese,\footnote{\versal{PAVESE}, Cesar. \emph{Il mestiere di
...
V. Orlóv\footnote{\versal{TSVETÁIEVA}, Marina. \emph{Obras
...
respeito\footnote{Cf. \versal{LOTMAN}, I. M. \emph{Estrutura do
...
reunidas}\footnote{\versal{TSVETÁIEVA}, Marina. \emph{Nezobránnye
...
Poets}\footnote{\versal{TSVETAYEVA}, Marina. \emph{Selected
...
self"-exposure.} (\versal{TSVETAYEVA}, 1974, introdução,
tradução nossa)}
\end{quote}
...
antes,\footnote{\versal{DONNE}, J. \emph{Selected poems}.
...
\versal{NKVD}. (\versal{N}. da \versal{E}.)} Amadurecera cedo, em
...
no \emph{front} durante a Segunda Guerra. (\versal{N}. do
\versal{E}.)}
...
(Tradução de Augusto de Campos de Boris Schnaiderman, \versal{CAMPOS}, 1968, p. 163)
...
(Tradução de Haroldo de Campos, \versal{CAMPOS}, 1968, p. 160)

\end{verse}

\chapter{\emph{Encontros com Liz e outras histórias}, de Leonid
Dobýtchin\footnote{Publicado como prefácio de \versal{DOBÝTCHIN},
...
sentimental},\footnote{\versal{CHKLÓVSKI}, Víktor. \emph{Viagem
...
Chklóvski apoia o Partido Socialista Revolucionário (\versal{SR}),
...
1920 a 1922, participa do \versal{OPOIAZ}, círculo dos formalistas
...
\emph{Nóvyi Lef}. (\versal{N}. da {E}.)} e discute sobre a Escola
...
\versal{SR} citando seu nome. Em março, Víktor é procurado e
...
De volta à \versal{URSS}, dedica"-se a livros de memórias
...
Alexandre \versal{III}, por alguns anos, no mar Negro. Entretanto,
...
\emph{Desastres}\footnote{\versal{CHARMS}, Daniil.
...
Relata um de seus biógrafos (\versal{CHARMS}, 2003, p. 135) que, sempre
...
cadernos de apontamentos do próprio Kharms,\footnote{\versal{ANEMOTE},
Anthony, \versal{SCOTTO}, Peter. \emph{I am a Phenomenon out of the
...
``espiritual'', entre outros significados\footnote{\versal{OSTRASHEVSKY},
Eugene (org.). \emph{\versal{OBERIU} -- An Anthology of Russian
Absurdism}. Illinois: Northwestern University Press, 2006, p.
\versal{XV}.} ---, designava cada um dos membros do grupo de
...
Jean"-Jacques Jaccard\footnote{\versal{JACCARD}, Jean"-Philippe.
...
(\versal{KHARMS}, 2013, p. 255)
\end{verse}

No entanto, sabe"-se, pelas memórias da segunda mulher\footnote{\versal{DURNOVÓ}, Marina. \emph{Meu marido Daniil Kharms} (\emph{Moi muj Daniil Kharms}). Moscou, \versal{IMA}-press, 2005.}, que mesmo naquela época as crianças o aplaudiam: ``era só ele comparecer ao Palácio dos Pioneiros, às margens do Fontanka, onde ocorriam as matinês dominicais infantis, que as crianças gritavam, pulavam, batiam palmas''. Kharms acompanhava a declamação dos poemas, que elas sabiam de cor, com mágicas que as encantavam. Dos artistas que lá se apresentavam, ele era o que tinha mais sucesso. Porém, era estranho --- diz a sua mulher ---, pois Daniil, durante sua vida inteira jamais as suportou: detestava as crianças. O dom de suscitar o riso, reforçado pelo seu aspecto (era alto, magro, usava cachimbo à moda de Sherlock Holmes e chapéu de abas), era inato nele; a própria mulher conta que era só Daniil começar a ler um texto seu, tanto infantil quanto adulto, que ela mesma ria sem poder se controlar. Essa tendência natural, porém, tem por trás, como sustentação, todo um sistema especulativo\footnote{\versal{CHARMS}, Daniil. \emph{Casi}. Organização, tradução e posfácio Rosanna Giaquinta. Milão: Adelphi, 1990, p. 309.} e artístico do qual sintetizaremos alguns aspectos a seguir. Infelizmente o período em que viveu se encarregou de transformar paulatinamente esse riso em esgar, em que, porém, o paradoxo e a sutil inteligência humorística\footnote{\versal{CHARMS}, 2003.} sempre estão presentes.
...
nada, e seu equivalente --- a morte''\footnote{\versal{JACCARD},
1991, p. 186.}.
...
a água se torna ``dura como a pedra'' (\versal{JACCARD}, 1991, p.
187): 
...
vários conceitos, tomados e retomados nos escritos, muitos dos quais foram selecionados
 para esta antologia (\versal{KHARMS}, 2013). Para se acompanhar em
...
Em 1924, aos dezenove anos, já escrevia em seu diário (\versal{ANEMOTE}, 2013, nº 1, tradução nossa): ``o
...
``real'' tal como ele o vê, fixado ``sob um ângulo agudo''\footnote{\versal{JACCARD}, 1991, p. 278.}, estaria muito ligado à vida, embora vida de
...
Yankelevich\footnote{\versal{YANKELEVICH}, Matvei (org.). \emph{Today I wrote nothing}. Nova York: Overlook Duckworth, 2007.} quer ver no absurdo de Kharms algo parecido com ``a vida como ela
...
de dois elementos. Com efeito, no manifesto da \versal{OBERIU} (2 de
...
representado admiravelmente na peça \emph{Elizaveta Bam} (\versal{KHARMS}, 2013, p.184), escrita
e produzida por Kharms para a seção teatral da \versal{OBERIU} e
apresentada no sarau de lançamento do grupo.

É assim que a peça é sintetizada\footnote{\versal{ROBERTS}, Graham. \emph{The Last Soviet Avant"-garde}. Nova York:
...
de Kafka (que Kharms certamente não conhecia)''(\versal{CHARMS}, 2003, p. 143).
...
(\versal{ANEMOTE}, 2013, p. 95, tradução nossa)
\end{quote}
...
deixarem um fio solto em seus tecidos\footnote{\versal{CALVINO}, Ítalo. \emph{Assunto encerrado -- discursos sobre literatura
...
de 1934 (\versal{KHARMS}, 2013, p. 77). Por sinal, Jaccard (1995, p. 162)
...
literatura russa}\footnote{\versal{NABÓKOV}, Vladímir. \emph{Lições de literatura russa}. Organização e tradução Jorio
...
violência, a crueldade''. (\versal{NABÓKOV}, 2014, p. 368)
...
autobiografia.\footnote{\versal{NABÓKOV}, Vladímir. \emph{A pessoa em questão}. São Paulo: Companhia das Letras, 1994.
...
--- as duas imagens se mesclando num clarão funesto''. (\versal{NABÓKOV}, 2014, p. 237)
...
Seymour"-Jones:\footnote{\versal{SEYMOR"-JONES}, Carole}. \emph{Uma
...
\footnote{\versal{BRODSKY}, Joseph. \emph{Menos que um}. São Paulo: Companhia das Letras, 1994.
...
demagogo ou um tirano''. (\versal{BRODSKY}, 1994, p.130)
...
em russo),\footnote{\versal{LOSEFF}, Lev. \emph{Joseph
...
incuráveis},\footnote{\versal{BRÓDSKI}, Ióssif.
...
mais importante, publicada nos \versal{EUA} em 1986 --- e aqui
...
em \emph{Quase uma elegia}).\footnote{\versal{BRODSKY},
...
eu próprio não irei perceber --- isto é, a morte'' (\versal{BRODSKY}, 1994, p. 20). Quando ela
...
Leningrado. Acabou exilado para os \versal{EUA} (1972), após o processo
...
estava bastante inflacionado verbalmente, um pouco como a situação
 dos versos livres nos Estados Unidos de hoje''. (\versal{BRODSKY}, 
1994, p. 80) 
...
agradar a uma sombra'',\footnote{\versal{BRODSKY}, Joseph. Para agradar a uma sombra.
 In: \versal{AUDEN, W. H.} \emph{Poemas}. Tradução José Paulo Paes e 
...
volume \emph{To Urania},\footnote{\versal{BRODSKY}, Joseph. 
...
literatura russa de hoje, mas também na dos \versal{EUA}, para onde o escritor
...
Cultural},\footnote{\versal{DOVLÁTOV}, Serguei. \emph{Parque Cultural}.
...
férias (e exílio) e que, durante a \versal{URSS}, foi transformada em
...
vida na \versal{URSS}, descrita por ele com muito humor (cáustico). 
...
diabo, eu a dei de graça\ldots{}'' (\versal{DOVLÁTOV}, 2014, Prefácio, p. 14).
...
de sua vida na \versal{URSS}; \emph{O ofício} (1985), sobre sua
``carreira'' na \versal{URSS} e na América; \emph{Compromisso} (1981),
...
outro malogro completamente casual;\footnote{Em Tállin (Estônia), onde Serguei Dovlátov morou
 ...
 cancelada, às portas da gráfica. (\versal{N}. da \versal{E}.)} \emph{A zona} (1982), seu serviço
...
Tânia (baseada em Elena Dovlátova), que decide emigrar com a filha para os \versal{EUA} (tinha direito a sair por ser judia)
...
cachorrinha de estimação, acaba deixando o país, rumo aos \versal{EUA}, onde terá sucesso de crítica
...
Se em \emph{Parque Cultural} Dovlátov expressa suas dúvidas quanto
 à emigração, em \emph{O ofício}, também publicado no Brasil,\footnote{\versal{DOVLÁTOV}, Serguei. \emph{O ofício}. Tradução
...
(\versal{DOVLÁTOV}, 2017, p. 24).

\end{quote}

Ou então, em outro \versal{SOLO}:
...
Intrigante e apaixonante é \emph{Salmo} (1975),\footnote{\versal{GORENSTEIN}, Friedrich. 
...
do século \versal{XX} (\emph{deskulakização}, grande fome na Ucrânia, invasão alemã,
...
popular\ldots{}''
(\versal{GORENSTEIN}, 2017, p. 348). Por sinal, essa ideia 
é compartilhada com o socialista Belínski, o maior crítico russo 
do século \versal{XIX}, que, numa carta de 1848 a Ánnenkov, 
...
Ah, como ele os detestava!\ldots{}'' (\versal{GORENSTEIN}, 2017, p. 247).
...
soviética}.\footnote{\versal{AMACHER}, Korine. \emph{L’ouvre de
 ...
 \versal{XLI}-2, 2002.} É essa rejeição que Gorenstein castiga no romance, que, no entanto, como a maioria dos escritos do autor, encerra com
uma nota positiva: 
...
mesmo amarga, é uma sorte e um privilégio\ldots{} (\versal{GORENSTEIN}, 2017, p. 387).
\end{quote}
...
Estas últimas surgiram com grande força na segunda metade do século \versal{XIX},
...
Óssip Mandelstam, nos anos 1910, buscou trazer à poesia elementos mais
 simples, pautados na realidade, menos metafóricos. (\versal{N.} da 
\versal{E}.)} que surgiu pouco depois, nem sobre os seus
...
futurismo}.\footnote{\versal{POMORSKA}, Krystyna. \emph{Formalismo
...
Khlébnikov, os textos de Óssip Brik sobre o ritmo,\footnote{\versal{BRIK}, Óssip. Ritmo e Sintaxe. In: 
\versal{TOLEDO}, 1976.} e o já mencionado
...
\footnote{\versal{TYNJANOV}, Jurij. \emph{Formalismo e
 storia letteraria. Tri studi sulla poesia russa}. Tradução e introdução de Maria Di Salvo. Turim: Eiunaudi, 1973, p. \versal{XXI}.}
...
a cem anos. Bastaria fazer um rápido retrospecto, nem que fosse pelas
 teorias estéticas dos séculos \versal{IX} e \versal{XX}, para se 
...
apresentada a imagem?\footnote{\versal{CESERANI}, Reno. 
...
totalidade em relação à qual ele se define. (\versal{VATTIMO}, 1985, p. 14--15)
\end{quote}
...
\footnote{\versal{VATTIMO}, Reno. \emph{La fine della modernità}. Milão:
...
Luigi Pareyson --- de quem Vattimo foi aluno
 --- em sua \emph{Teoria da formatividade}\footnote{Cf. \versal{PEREYSON}, Luigi. 
...
\chapter*{Aurora Bernardini entrevista Victor Erlich: sobre as reverberações do formalismo russo na crítica literária americana\footnote{Publicada na \emph{Revista da \versal{USP}}, nº24, dez/jan, 1994--1995.}}
...
a rima, o ritmo, a entonação, o arranjo formal das palavras e a
 seleção lexical. (\versal{N.} da \versal{E.})}
