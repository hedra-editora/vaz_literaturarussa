...
olhada''. Aproximo"-me e custo a acreditar: \emph{Velimir Khlébnikov -- Natureza da Criação}, era o título, o e autor, R. V.
...
\emph{Nótch smótritsa, kak Tiútchev, (Ночь смотрится, как
тютчев,)}

\emph{Zamiérnoebezmiérnympólnia. (Замерное безмерным полня)}

\textbf{III} IMAGEM FALTANDO

\textbf{IV} IMAGEM FALTANDO
...
Santos, juntos.\footnote{\versal{KHLÉBNIKOV}, Velimir. In: Dugánov, R. V.
...
Quando morrem os homens -- cantam.\footnote{\versal{KHLÉBNIKOV}, Velimir.
...
16 set. 1921\footnote{\versal{TSVETÁIEVA}, M. em \emph{Poesia Russa Moderna}, (trad. De Haroldo de Campos) op. cit. p.158.}
...
York\footnote{\versal{TSVETAIEVA}, M. \emph{Prosa}. New York, Chekhov Publish
...
Orlóv\footnote{\versal{TSVETAIEVA}, M. \emph{Izbrannoie} (obras escolhidas).
...
respeito\footnote{Cf. \versal{LOTMAN}, I. M.} \emph{Struktura khuddjestvennovo
...
\emph{derreter no calor dos desígnios inspirados do homem\lodts{}}
...
\chapter{Um escritor russo na América -- Dovlátov: \emph{Parque Cultural} e \emph{O ofício}\footnote{Uma primeira versão deste ensaio foi publicada como ``Parque cultural ou um escritor russo na América''. In:
...
\chapter{Minha última viagem sentimental à \versal{URSS}\footnote{Artigo
