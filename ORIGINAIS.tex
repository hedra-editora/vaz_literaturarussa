...
chama de `\textbf{orgânico de ordem geral}' (doravante grifos nossos), que caracteriza, em geral,
...
%\(\frac{\text{OA}}{\text{OB}} = \ \frac{\text{OB}}{\text{OC}}\) \ldots{}
...
%\includegraphics[width=5.90556in,height=2.95139in]{media/image4.jpeg}
