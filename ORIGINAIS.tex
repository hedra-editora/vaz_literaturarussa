...
\emph{Jornal da Sibéria}\footnote{No original: ``\emph{Des vers, des vers,
  ...
  français, absolument! Si possible envie moi le dernier Genlis, \emph{Childe Harold}, Lamartine\ldots{} les œuvres dramatiques de Schiller, \emph{Don Juan}\ldots{} et \emph{Le Courier de Siberie}'' (\emph{Idem, ibidem}).}}.
\end{quote}
...
nacionalidade estrangeira. Eis \emph{A cena do Faust}, eis \emph{O cavaleiro avaro},
...
salvá"-la não por intermédio de Cristo, mas igualmente da violência!'' (\emph{O idiota}, 2002, pp. 107--108).
\end{quote}
...
especialmente em \emph{Crime e castigo} cujo debate, juntamente com a descrição de seus
...
fraco, ou melhor, de intensidade menor (reproduzido na
...
peu}, donc lá ou commence l'art}''\footnote{\emph{Écrits sur l´art}, pp.
200--201.}.
...
(\emph{Três russos e como me tornei um escritor}, pp. 16--17).
\end{quote}
...
escolha dos métodos agrícolas\ldots{}'' (\emph{Ibidem}, p. 168).
\end{quote}
...
escritor''\footnote{Górki, \emph{Três russos e como me tornei escritor}, 2006, p. 51.}.
...
durante os períodos precedentes (Liev Tolstói, \emph{Diário íntimo, 1900--1904}).
\end{quote}
...
defeitos [e qualidades] da nação''\footnote{Górki, \emph{Três russos e como
...
poder"-se"-ia recorrer à hipótese da ``visão de mundo''\footnote{E. Raimondi, \emph{Tecniche della critica litteraria}, 
...
administrativa e política do país, mas principalmente no campo (Chklóvski, 1967, p. 380).
\end{quote}
